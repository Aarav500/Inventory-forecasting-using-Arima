...
# Ensure the Date index has a weekly frequency
data = data.asfreq('W')  # Set frequency to weekly ('W')
...
model = ARIMA(train, order=(3, 2, 3))  # Adjust order as needed
...
for i in range(len(test)):
    ...
    model = ARIMA(train_subset, order=(3, 2, 3))
